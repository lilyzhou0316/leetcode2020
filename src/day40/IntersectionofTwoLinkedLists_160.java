...
reads as [5,6,1,8,4,5]. There are 2 nodes before the intersected node in A; There are 3 
...
two lists intersect). From the head of A, it reads as [1,9,1,2,4]. From the head of B, it 
